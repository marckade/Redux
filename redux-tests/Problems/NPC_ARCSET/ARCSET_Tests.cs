...
public class ARCSET_Tests
{
    ...
    public void ARCSETGraph_Default_Instantiation_Test(){
        ...
        Assert.Equal( "{{1,2,3,4},{(4,1),(1,2),(4,3),(3,2),(2,4)},1}",testingArc.defaultInstance); //tests default instance
    }
    ...
    public void ARCSETGraph_DFS(){
        ...
        Assert.Equal(testEdge1.directedString(), eList[0].directedString());

        Node edge2_node1 = new Node("3");
        Node edge2_node2 = new Node("2");
        Edge testEdge2 = new Edge(edge2_node1, edge2_node2);
        Assert.Equal(testEdge2.directedString(), eList[1].directedString());
    }
    ...
    public void ARCSET_verify_falseoutput(){
        ...
        verifier.verify(testArc,"(3,2),(4,1)");
    }
    ...
    [InlineData("{{a,b,c,d,e,f,g},{{a,b},{a,c},{c,d},{c,e},{d,f},{e,f},{e,g}},3}","{{a0,a1,b0,b1,c0,c1,d0,d1,e0,e1,f0,f1,g0,g1},{(a1,b0),(b1,a0),(a1,c0),(c1,a0),(c1,d0),(d1,c0),(c1,e0),(e1,c0),(d1,f0),(f1,d0),(e1,f0),(f1,e0),(e1,g0),(g1,e0),(a0,a1),(b0,b1),(c0,c1),(d0,d1),(e0,e1),(f0,f1),(g0,g1)},3}")]
