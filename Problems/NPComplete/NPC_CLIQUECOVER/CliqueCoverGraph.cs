...
class CliqueCoverGraph : UndirectedGraph
{
 ...
 /// <param name="cliqueInput"> string input</param>
  ...
  public CliqueCoverGraph(string cliqueInput, string usingCliqueNodes){
        string pattern;
        ...
        if(inputIsValid){
            ...
            foreach(string nodeName in nodeStringList){
               _nodeList.Add(new CliqueCoverNode(nodeName,String.Empty));
           }
           //Console.WriteLine(nMatches[0]);
            ...
            foreach(Match medge in eMatches2){
                ...
                Node n1 = new CliqueCoverNode(edgeSplit[0],String.Empty);
                Node n2 = new CliqueCoverNode(edgeSplit[1],String.Empty);
